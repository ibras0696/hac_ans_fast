Отлично, Ибрагим! Ты выбрал грамотную архитектуру, и я помогу тебе пройти путь от идеи до реализации.
...
* При первом входе, если анкета не заполнена — показываем форму.
